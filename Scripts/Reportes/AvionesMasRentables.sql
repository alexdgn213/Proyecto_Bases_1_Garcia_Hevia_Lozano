...
FROM
    (select a.aer_codigo as codigo, mod_nombre as modelo, pp.pru_pie_fecha_estimada - pp.pru_pie_fecha_realizacion as retraso
    ...
    UNION ALL
    select a.aer_codigo as codigo, mod_nombre as modelo, pa.pru_aer_fecha_estimada - pa.pru_aer_fecha_realizacion as retraso
